...
export type Query = {
  ...
  getAllDrinks?: Maybe<Array<Maybe<Drink>>>;
...
export type QueryResolvers<ContextType = DataSourceContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  bar?: Resolver<Maybe<ResolversTypes['Bar']>, ParentType, ContextType, RequireFields<QueryBarArgs, 'name'>>;
  foos?: Resolver<Maybe<Array<Maybe<ResolversTypes['Foo']>>>, ParentType, ContextType>;
  getAllDrinks?: Resolver<Maybe<Array<Maybe<ResolversTypes['Drink']>>>, ParentType, ContextType>;
